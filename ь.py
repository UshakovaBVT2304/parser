...
def found_vacancies_and_fill_db(connection, vacancies_title=None, city_id=None, salary=None):
    vacancies_to_insert = []
    page = 0
    has_more_pages = True
    count=0
...
def main():
    ...
    found_vacancies_and_fill_db(connection, vacancies_title=data['vacancies_title'], city_id=data['city_id'])
